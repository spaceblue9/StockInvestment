...
try {
  ...
  assertIncludes(html, [
    ...
    "Choose package to request",
    "Create account and request package",
    "Simulation",
  ...
  assertIncludes(appJs, [
    ...
    "Please choose Starter or Pro before creating an account.",
    ...
    "Approve pending request above",
    "Admin override package",
    "Do not save this row again",
