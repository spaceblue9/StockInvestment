...
- T92 Done: เพิ่ม click filter ให้ `Action mix` และ `Score distribution` ในหน้า Portfolio เพื่อกรอง Recommended actions ตาม action group และ score band พร้อม selected/reset behavior, docs/regression markers และ targeted tests ผ่าน
